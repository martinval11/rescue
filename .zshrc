...
alias l='ls'
alias mk='mkdir'
alias template='yarn create vite'
alias rf='rm -rf'
alias s='sensors'
alias rf!='sudo rm -rf'
alias mocp='mocp -T /usr/share/moc/themes/darkdot_theme'
alias m='mocp -T /usr/share/moc/themes/darkdot_theme'
alias info='exiftool'
alias fzy='ls | fzy -l 50'
alias neofetch='neofetch --ascii /home/martin/Downloads/logo.txt'
alias ht='htop'
alias config='nvim $HOME/.zshrc && zsh'
alias mplay='cd $HOME/Music && mpv --loop'
alias R='sudo reboot'
alias S='sudo poweroff'
source /home/martin/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
...
# Bun
export BUN_INSTALL="/home/martin/.bun"
