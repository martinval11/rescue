sudo xbps-install picom i3 neovim mlocate xtools flatpak xfce4-screenshooter nano brightnessctl firefox rofi moc acpi zsh lm_sensors python3 python3-pip wget curl bleachbit mtpaint virtualbox-ose virtualbox-ose-dkms htop neofetch nnn pcmanfm dkms base-devel git vscode fzf alacritty
